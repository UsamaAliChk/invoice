...
export default function AddUserAddressInfo({setopen2,setIsOpen,open2,addnewcontact}) {
                        ...
                        <Modal.Body>
                            ...
                            <Row style={{marginTop:"30px"}}>
                                ...
                                <Row className="modal-buttons-container">
                                    <Button style={{marginLeft:'15px'}} className="modal-button" onClick={e=>{setopen2(false);setIsOpen(true)}}>Previous</Button>
